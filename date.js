let months_accusative = ['', 'Ianuarias', 'Februarias', 'Martias', 'Apriles', 'Maias', 'Iunias', 'Iulias', 'Augustas', 'Septembres', 'Octobres', 'Novembres', 'Decembres', 'Ianuarias'];
let months_ablative = ['', 'Ianuariis', 'Februariis', 'Martiis', 'Aprilibus', 'Maiis', 'Iuniis', 'Iuliis', 'Augustis', 'Septembribus', 'Octobribus', 'Novembribus', 'Decembribus', 'Ianuariis'];

let numbers_accusative = ['nihil', 'primum', 'secundum', 'tertium', 'quartum', 'quintum', 'sextum', 'septimum', 'octavum', 'nonum', 'decimum', 'undecimum', 'duodecimum', 'tertium decimum', 'quartum decimum', 'quintum decimum', 'sextum decimum', 'septimum decimum', 'duodevicesimum', 'undevicesimum', 'vicesimum'];

let months_short = ['', 'Ian.', 'Feb.', 'Mar.', 'Apr.', 'Mai.', 'Iun.', 'Iul.', 'Aug.', 'Sept.', 'Oct.', 'Nov.', 'Dec.', 'Ian.'];

let numbers_short = ['N', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII', 'XIII', 'XIV', 'XV', 'XVI', 'XVII', 'XVIII', 'XIX', 'XX'];
...
function shortRomanDate(date) {
    ...
    if (day > kalends && day < (nones - 1)) {
        return 'a.d. ' + numbers_short[nones - day + 1] + ' Non. ' + months_short[month];
    }
    ...
    if (day > nones && day < (ides - 1)) {
        return 'a.d. ' + numbers_short[ides - day + 1] + ' Eid. ' + months_short[month];
    }
    ...
    if (day > ides && day < lastDayOfMonth) {
        return 'a.d. ' + numbers_short[(lastDayOfMonth + 1) - day + 1] + ' Kal. ' + months_short[month + 1];
    }
