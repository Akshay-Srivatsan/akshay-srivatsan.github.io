...
latinVariants =
    [ Variant "default" "litterae quadratae" "la" Nothing
    , Variant "unciali" "litterae unciales" "la-Latg" (Just "to_ascii")
    , Variant "italica" "litterae italicae" "la-Ital" (Just "to_italics")
    , Variant "tamulica" "litterae tamulicae" "ta" (Just "to_tamil")
    , Variant "grantha" "litterae granthae" "ta" (Just "to_grantha")
    , Variant "brahmi" "litterae brahmes" "ta" (Just "to_brahmi")
    ]
...
replacementsFor page
    | pageSource page == "content/tamil.md" =
        [ ("akshay", "Akshay"), ("sreevadhsan", "Srivatsan"), ("ɕɾiːʋadsan", "ɕɾiːʋatsan")
        , ("श्रीवत्सऩ्", "श्रीवत्सन्"), ("kanini", "ganini"), ("kaɳini", "gaɳini")
        , ("sdaanford", "Stanford"), ("menlo", "Menlo"), ("kaardaa", "Carta")
        , ("kidhub", "GitHub"), ("lingadin", "LinkedIn"), ("aangila", "Aangila")
        , ("lattheen", "Latin"), ("samsgirudha", "Samskirutha"), ("thamizh", "Tamil")
        , ("hindhi", "Hindi"), ("piranj", "French"), ("yunigs", "UNIX"), ("piyaano", "piano")
        , ("saaraa aashur", "Sara Achour"), ("taasan englar", "Dawson Engler")
        , ("keedh vinsdeen", "Keith Winstein"), ("jaan midcchel", "John Mitchell")
        , ("paad haanrahaan", "Pat Hanrahan"), ("piraansu kaashoog", "Frans Kaashoek")
        , ("aayeled thirezen", "Ayelet Drazen"), ("jaanatthan koolaa", "Jonathan Kula")
        , ("em ai ti", "MIT"), ("em ai tee", "MIT"), ("taansbireg", "Dancebreak")
        , ("sdaanbord", "Stanford"), ("svingu", "Swing"), ("taansars", "Dancers")
        , ("viyannees", "Viennese"), ("paal", "Ball"), ("vaalds", "Waltz"), ("polkkaa", "Polka")
        ]
    | pageSource page == "content/sanskrit.md" =
        [ ("akshay", "Akshay"), ("shreevatsan", "Srivatsan"), ("ayelet", "Ayelet")
        , ("ayeleṭ", "Ayelet"), ("drejen", "Drazen"), ("ḍrejen", "Drazen")
        , ("jonathan", "Jonathan"), ("koolaa", "Kula"), ("kūlā", "Kula")
        , ("keeth", "Keith"), ("kīth", "Keith"), ("vinsteen", "Winstein")
        , ("vinsṭīn", "Winstein"), ("daasan", "Dawson"), ("ḍāsan", "Dawson")
        , ("englar", "Engler"), ("saaraa", "Sara"), ("sārā", "Sara")
        , ("aachor", "Achour"), ("āchor", "Achour"), ("jon", "John")
        , ("micchel", "Mitchell"), ("paat", "Pat"), ("pāṭ", "Pat")
        , ("haanrahaan", "Hanrahan"), ("hānrahān", "Hanrahan"), ("frāns", "Frans")
        , ("fraans", "Frans"), ("kāshoek", "Kaahoek"), ("kaashoek", "Kaahoek")
        , ("linkdin", "LinkedIn"), ("eepatram", "e-patram"), ("sṭenforḍ", "Stanford")
        , ("ḍānsbrek", "Dancebreak"), ("daansbrek", "Dancebreak"), ("vīyenna", "Vienna")
        , ("veeyenna", "Vienna")
        ]
    | pageSource page == "content/hindi.md" =
        [ ("akshay", "Akshay"), ("shreevatsan", "Srivatsan"), ("prograam", "program")
        , ("stainford", "Stanford"), ("yooniversiti", "University"), ("baacelors", "bachelors")
        , ("maasters", "masters"), ("digri", "degree"), ("digree", "degree")
        , ("kamapyootar", "computer"), ("aangrezi", "Angrezi"), ("laatin", "Latin")
        , ("tamil", "Tamil"), ("hindi", "Hindi"), ("sanskrit", "Sanskrit")
        , ("dipaartment", "department"), ("kaarta", "Carta"), ("opreting", "operating")
        , ("sistam", "system"), ("dizaain", "design"), ("faisbuk", "Facebook")
        , ("softavair", "software"), ("piyaano", "piano"), ("menlo", "Menlo")
        , ("skool", "School"), ("github", "GitHub"), ("linkidin", "LinkedIn")
        , ("ee-patr", "e-patr"), ("pi ec di", "PhD"), ("தமில்", "தமிழ்")
        , ("em aai ti", "MIT"), ("saara ashur", "Sara Achour"), ("daasan engalar", "Dawson Engler")
        , ("keeth vinsteen", "Keith Winstein"), ("jaan mitcel", "John Mitchell")
        , ("pait hainrahain", "Pat Hanrahan"), ("ayelet drezen", "Ayelet Drazen")
        , ("jaanthan kool", "Jonathan Kula"), ("softaveyar", "software"), ("programr", "programmer")
        ]
    | otherwise = []
