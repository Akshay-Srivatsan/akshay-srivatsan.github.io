...
replacementsFor page
    | pageSource page == "content/tamil.md" =
        ...
        , ("sdaanford", "Stanford"), ("sdaanbord", "Stanford"), ("menlo", "Menlo")
        , ("yunigs", "UNIX")
        ]
    | pageSource page == "content/sanskrit.md" =
        [ ("akshay", "Akshay"), ("shreevatsan", "Srivatsan"), ("sṭenforḍ", "Stanford")
        ]
    | pageSource page == "content/hindi.md" =
        [ ("akshay", "Akshay"), ("shreevatsan", "Srivatsan")
        , ("stainford", "Stanford"), ("yooniversiti", "University")
        , ("தமில்", "தமிழ்")
        ]
    | otherwise = []
